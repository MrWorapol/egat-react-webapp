...
function buildPaymentChart(paymentChart: INetPaymentChart) {
    ...
    let labels = [
        `Net Energy Trading Payment : ${Number(paymentChart.tradingPayment * 100).toFixed(2)} Baht ${Number(paymentChart.tradingPayment * 100 / sum).toFixed(2)}%`,
        `Grid Used : ${Number(paymentChart.gridUsed * 100).toFixed(2)} Baht ${Number(paymentChart.gridUsed * 100 / sum).toFixed(2)}%`,
        `Wheeling Charge : ${Number(paymentChart.wheelingCharge * 100).toFixed(2)} Baht ${Number(paymentChart.wheelingCharge * 100 / sum).toFixed(2)}%`,
    ];
